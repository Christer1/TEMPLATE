...
<div class="wrap-input100 validate-input" data-validate="Enter your surnanme">
...
<div class="wrap-input100 validate-input" data-validate="Enter your preferred username">
<input class="input100" type="text" name="username" placeholder="Username (For login)">
<span class="focus-input100"></span>
<span class="symbol-input100">
<i class="fa fa-user" aria-hidden="true"></i>
</span>
...
<div class="wrap-input100 validate-input" data-validate="Enter a vaild whatsapp number">
<input class="input100" type="text" name="surname" placeholder="Valid whatsapp number">
<span class="focus-input100"></span>
<span class="symbol-input100">
